...
public class ConsulServiceImpl implements ConsulService {
    ...
    public void setKVValue(Map<String, String> kvValue) {
        for (Map.Entry<String, String> kv : kvValue.entrySet()) {
            try {
                ...
                log.info("SetKVValue exception: {},kvValue: {}", e.getMessage(), kvValue);
            }
        }
    }
    ...
    public void setKVValue(String key, String value) {
        try {
            ...
            log.info("SetKVValue exception: {},key: {},value: {}", e.getMessage(), key, value);
        }
    }
    ...
    public Map<String, String> getKVValues(String keyPrefix) {
        ...
        try {
            ...
            log.info("GetKVValues exception: {},keyPrefix: {}", e.getMessage(), keyPrefix);
        }
        return null;
    }
    ...
    public List<String> getKVKeysOnly(String keyPrefix) {
        ...
        try {
            ...
            if (response.getValue() != null){
                list.addAll(response.getValue());
            }

            return list;
        } catch (Exception e) {
            log.info("GetKVKeysOnly exception: {},keyPrefix: {}", e.getMessage(), keyPrefix);
        }
        return null;
    }
